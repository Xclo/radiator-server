...
var CloudFoundryOrgs = require("cf-client").Organizations;
var CloudFoundryOrgQuota = require("cf-client").OrganizationsQuota;
    ...
    return new Promise(function (resolve, reject) {
        ...
        try {
            ...
            CloudController.getInfo().then(function (result) {
                ...
                CloudFoundryOrgs.setToken(authorization);
                CloudFoundryOrgQuota.setToken(authorization);
